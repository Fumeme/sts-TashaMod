...
/*    */ {
	...
	/*    */ {
		...
		if (this.target.hasPower(DecayPower.POWER_ID) && this.target.getPower(DecayPower.POWER_ID).amount > 0) {
			...
			AbstractDungeon.actionManager
					.addToBottom(new RemoveSpecificPowerAction(this.target, this.source, DecayPower.POWER_ID));
