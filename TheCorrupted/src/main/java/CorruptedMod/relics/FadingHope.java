...
public class FadingHope extends CustomRelic {
    ...
    // ID, images, text.
    public static final String ID = CorruptedMod.CorruptedBase.makeID("PlaceholderRelic2");
    public static final String IMG = CorruptedBase.makePath(CorruptedBase.PLACEHOLDER_RELIC_2);
