package CorruptedMod.characters;
...
//(String name, PlayerClass playerClass, String[] orbTextures, String orbVfxPath, float[] layerSpeeds, AbstractAnimation animation)
        ...
        initializeClass(null, // required call to load textures and setup energy/loadout
                CorruptedMod.CorruptedBase.makePath(CorruptedMod.CorruptedBase.THE_DEFAULT_SHOULDER_1), // campfire pose
                CorruptedMod.CorruptedBase.makePath(CorruptedMod.CorruptedBase.THE_DEFAULT_SHOULDER_2), // another campfire pose
                CorruptedMod.CorruptedBase.makePath(CorruptedMod.CorruptedBase.THE_DEFAULT_CORPSE), // dead corpse
        ...
        this.loadAnimation(
                CorruptedMod.CorruptedBase.makePath(CorruptedMod.CorruptedBase.THE_DEFAULT_SKELETON_ATLAS),
                CorruptedMod.CorruptedBase.makePath(CorruptedMod.CorruptedBase.THE_DEFAULT_SKELETON_JSON),
                1.0f);
...
**/
    ...
    public Color getCardTrailColor() {
        return CorruptedMod.CorruptedBase.DEFAULT_GRAY;
    }
