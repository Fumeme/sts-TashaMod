...
public class MenacingPower extends TwoAmountPower {
    ...
    public static final String POWER_ID = CorruptedMod.CorruptedBase.makeID("MenacingPower");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public static final String IMG = CorruptedBase.makePath(CorruptedBase.MenacingPower);
