...
public class DecayPurge extends AbstractPower {
    ...
    public static final String POWER_ID = CorruptedMod.CorruptedBase.makeID("DecayPurge");
    ...
    public void atEndOfTurn(final boolean isPlayer) {
        ...
        if (owner.hasPower(DecayPower.POWER_ID) && owner.getPower(DecayPower.POWER_ID).amount > 0) {
