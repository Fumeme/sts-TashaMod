...
public class SappingStrike extends CustomCard {
    ...
    public static final String ID = CorruptedMod.CorruptedBase.makeID("SappingStrike");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = CorruptedBase.makePath(CorruptedBase.SappingStrike);
