...
public class CallZitong extends CustomCard {
    ...
    public static final String ID = CorruptedMod.CorruptedBase.makeID("CallZitong");
...
**/
    public static final String IMG_PATH = CorruptedBase.makePath(CorruptedBase.SappingStrike);
