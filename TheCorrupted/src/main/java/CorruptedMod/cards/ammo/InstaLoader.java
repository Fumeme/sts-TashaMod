...
public class InstaLoader extends AbstractCorrCard implements drawCardandAction.IDrawCardsAndDoCallback  {
    ...
    public static final String ID = CorruptedMod.CorruptedBase.makeID("InstaLoader");
