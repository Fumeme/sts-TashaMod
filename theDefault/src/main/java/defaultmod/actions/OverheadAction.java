...
/* 40 */         AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(target, source,
        new VulnerablePower(AbstractDungeon.getMonsters().getRandomMonster(true), 1, false), 1));

AbstractDungeon.actionManager.addToBottom(new ReducePowerAction(target, source,
