...
import defaultmod.powers.SpreadCorruptionPower;
...
public class SpreadCorruption extends CustomCard {
    ...
    public static final String ID = defaultmod.DefaultMod.makeID("SpreadCorruption");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = DefaultMod.makePath(DefaultMod.SpreadCorruption);
