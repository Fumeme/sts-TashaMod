...
public class AmmoOfBlocking extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(p, p, new AmmoOfBlockingPower(p, p, this.magicNumber), this.magicNumber));
        
    	if(magic((short) 2)) {
    		
			AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(p, p, new AmmoOfBlockingPower(p, p, this.block), this.block));
