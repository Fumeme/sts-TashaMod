...
public class AimForTheHead extends CustomCard {
	...
	public static final String ID = defaultmod.DefaultMod.makeID("AimForTheHead");
	private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
	public static final String IMG = DefaultMod.makePath(DefaultMod.TransMind);
